...
Today I used [yarn-berry-patch-package](https://github.com/sstchur/yarn-berry-patch-package) to patch \`${packageDetails.name}@${packageVersion}\` for the project I'm working on.
...
<em>This issue body was partially generated by yarn-berry-patch-package.</em>
`,
  })}`
}
...
export function maybePrintIssueCreationPrompt(
  ...
  if (vcs) {
    ...
    yarn yarn-berry-patch-package ${packageDetails.pathSpecifier} --create-issue
`)
  }
}
